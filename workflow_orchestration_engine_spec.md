...
Pi's working directory is the run worktree, so Pi may read and modify files in that worktree.
...
The system intentionally executes trusted workflows directly in the backend environment. This is acceptable only under the documented assumptions.
