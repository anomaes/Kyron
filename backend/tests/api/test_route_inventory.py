...
def test_required_http_and_websocket_routes_are_registered() -> None:
    ...
    required = {
        ...
        "/api/metrics",
        "/api/auth/me",
        "/api/auth/vscode/device",
        "/api/auth/vscode/authorize",
        "/api/auth/vscode/token",
        "/api/auth/vscode/revoke",
        "/api/admin/users",
        "/api/admin/pi-models",
        "/api/admin/pi-models/validate",
        "/api/admin/pi-models/active",
        "/api/admin/pi-models/revisions/{revision_id}/activate",
        "/api/pi/models/catalog",
        ...
        "/api/projects/{project_id}/webhook-secret",
