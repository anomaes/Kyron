...
const defaults: Record<NodeType, Record<string, unknown>> = {
  ...
  human_feedback: { commit_message: "Checkpoint: awaiting review", mr_title: "Workflow: ${WORKFLOW_NAME}", mr_description: "Approve or comment with @yoke feedback.", allow_comment_feedback: true, allow_approval: true },
