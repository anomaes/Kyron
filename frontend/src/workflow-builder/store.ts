...
const defaults: Record<NodeType, Record<string, unknown>> = {
  ...
  human_feedback: { approval_policy: "select-policy", commit_message: "Checkpoint: awaiting review", mr_title: "Workflow: ${WORKFLOW_NAME}", mr_description: "Approve or comment with @kyron feedback.", allow_comment_feedback: true, allow_approval: true },
  subworkflow: { workflow_id: "child_workflow", inputs: {}, output_mapping: {}, allow_failure: false },
  review_loop: { approval_policy: "select-policy", initial_workflow_id: "implement_changes", revision_workflow_id: "revise_from_feedback", inputs: {}, revision_inputs: { FEEDBACK: "${FEEDBACK}" }, commit_message: "Checkpoint: review iteration ${REVIEW_ITERATION}", max_iterations: 5, output_mapping: {} },
};
